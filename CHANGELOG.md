## 8.8.0
### 🎉 Features
* Configuration via `branch-config.json` file. 
	...
	- Easily toggle between your test and live keys within the `branch-config.json` file, streamlining the development and release process.
