...
public class FlutterBranchSdkHelper {
    ...
    BranchUniversalObject convertToBUO(HashMap<String, Object> argsMap) {
        ...
        buo.setCanonicalIdentifier(Objects.requireNonNull(canonicalIdentifier));

        if (argsMap.containsKey("canonicalUrl"))
            buo.setCanonicalUrl((String) Objects.requireNonNull(argsMap.get("canonicalUrl")));
        if (argsMap.containsKey("title"))
            buo.setTitle((String) Objects.requireNonNull(argsMap.get("title")));
        ...
        if (argsMap.containsKey("imageUrl"))
            buo.setContentImageUrl((String) Objects.requireNonNull(argsMap.get("imageUrl")));
        ...
        if (argsMap.containsKey("expirationDate"))
            buo.setContentExpiration(new Date((long) Objects.requireNonNull(argsMap.get("expirationDate"))));

        if (argsMap.containsKey("locallyIndex")) {
            boolean value = (boolean) Objects.requireNonNull(argsMap.get("locallyIndex"));
            if (value) {
        ...
        if (argsMap.containsKey("publiclyIndex")) {
            boolean value = (boolean) Objects.requireNonNull(argsMap.get("publiclyIndex"));
            if (value) {
        ...
        if (argsMap.containsKey("contentMetadata")) {
            ...
            if (contentMap != null) {
                if (contentMap.containsKey("quantity"))
                    contentMetadata.setQuantity((double) Objects.requireNonNull(contentMap.get("quantity")));
                if (contentMap.containsKey("price") && contentMap.containsKey("currency")) {
                    contentMetadata.setPrice((double) Objects.requireNonNull(contentMap.get("price")), CurrencyType.getValue((String) contentMap.get("currency")));
                }
                if (contentMap.containsKey("rating_average") || contentMap.containsKey("rating_count") ||
                    ...
                    if (contentMap.containsKey("rating")) {
                        rating = (double) Objects.requireNonNull(contentMap.get("rating"));
                    }
                    Double rating_average = null;
                    if (contentMap.containsKey("rating_average")) {
                        rating_average = (double) Objects.requireNonNull(contentMap.get("rating_average"));
                    }
                    ...
                    if (contentMap.containsKey("rating_max")) {
                        rating_max = (double) Objects.requireNonNull(contentMap.get("rating_max"));
                    }
                ...
                if (contentMap.containsKey("latitude") && contentMap.containsKey("longitude")) {
                    contentMetadata.setLocation((double) Objects.requireNonNull(contentMap.get("latitude")), (double) Objects.requireNonNull(contentMap.get("longitude")));
                }
                ...
                if (contentMap.containsKey("image_captions")) {
                    ...
                    for (int i = 0; i < Objects.requireNonNull(_imageCaptions).size(); i++) {
                        contentMetadata.addImageCaptions(_imageCaptions.get(i));
                    }
                }
                if (contentMap.containsKey("customMetadata")) {
                    for (Map.Entry<String, Object> customMetaData : ((HashMap<String, Object>) Objects.requireNonNull(contentMap.get("customMetadata"))).entrySet()) {
    ...
    LinkProperties convertToLinkProperties(HashMap<String, Object> argsMap) {
        ...
        if (argsMap.containsKey("matchDuration"))
            linkProperties.setDuration((int) Objects.requireNonNull(argsMap.get("matchDuration")));
        if (argsMap.containsKey("tags")) {
            ArrayList<String> _tags = (ArrayList<String>) argsMap.get("tags");
            for (int i = 0; i < Objects.requireNonNull(_tags).size(); i++) {
                linkProperties.addTag(_tags.get(i));
            }
        }
        if (argsMap.containsKey("controlParams")) {
            for (Map.Entry<String, String> content : ((HashMap<String, String>) Objects.requireNonNull(argsMap.get("controlParams"))).entrySet()) {
    ...
    BranchEvent convertToEvent(HashMap<String, Object> eventMap) {
        ...
        if ((boolean) Objects.requireNonNull(eventMap.get("isStandardEvent"))) {
        ...
        if (eventMap.containsKey("shipping"))
            event.setShipping((Double) Objects.requireNonNull(eventMap.get("shipping")));
        if (eventMap.containsKey("tax"))
            event.setTax((Double) Objects.requireNonNull(eventMap.get("tax")));
        ...
        if (eventMap.containsKey("adType"))
            event.setAdType(convertToAdType((String) Objects.requireNonNull(eventMap.get("adType"))));
        if (eventMap.containsKey("customData")) {
            for (Map.Entry<String, String> customData : ((HashMap<String, String>) Objects.requireNonNull(eventMap.get("customData"))).entrySet()) {
    ...
    BranchQRCode convertToQRCode(HashMap<String, Object> qrCodeMap) {
        ...
        if (qrCodeMap.containsKey("width")) {
            branchQRCode.setWidth((int) Objects.requireNonNull(qrCodeMap.get("width")));
        }
        if (qrCodeMap.containsKey("margin")) {
            branchQRCode.setMargin((int) Objects.requireNonNull(qrCodeMap.get("margin")));
        }
        if (qrCodeMap.containsKey("codeColor")) {
            branchQRCode.setCodeColor((String) Objects.requireNonNull(qrCodeMap.get("codeColor")));
        }
        if (qrCodeMap.containsKey("backgroundColor")) {
            branchQRCode.setBackgroundColor((String) Objects.requireNonNull(qrCodeMap.get("backgroundColor")));
        }
        ...
        if (qrCodeMap.containsKey("centerLogoUrl")) {
            branchQRCode.setCenterLogo((String) Objects.requireNonNull(qrCodeMap.get("centerLogoUrl")));
        }
        return  branchQRCode;
    }
